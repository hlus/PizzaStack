...
export const Button: React.FC<Props> = ({
  ...
  const buttonClasses = clsx(
    `text-sm text-gray-900  px-4 rounded-md transition-all`,
    {
      ...
      "bg-amber-400 hover:bg-amber-500 hover:border-amber-500 disabled:hover:bg-amber-400 disabled:hover:border-amber-400":
        variant === ButtonVariant.Primary,
      "bg-red-400 hover:bg-red-500 hover:border-red-500 disabled:hover:bg-red-400 disabled:hover:border-red-400":
