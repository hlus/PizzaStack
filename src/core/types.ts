...
export type CreateOrderMutationVariables = Exact<{
  ...
  client_phone: Scalars['String']['input'];
  comment?: InputMaybe<Scalars['String']['input']>;
  items: Array<OrderMenuItem> | OrderMenuItem;
  payment_type: Scalars['String']['input'];
}>;
...
export type GetMenuItemsForCartQuery = { __typename?: 'query_root', menu: Array<{ __typename?: 'menu', id: any, image: string, title: string, price: any }> };
...
export type UpdateCustomerDataMutation = { __typename?: 'mutation_root', update_customers_by_pk?: { __typename?: 'customers', id: any, address?: string | null, name?: string | null, phone: string } | null };


export const CreateOrderDocument = gql`
    mutation CreateOrder($client_address: String!, $client_name: String!, $client_phone: String!, $comment: String = "", $items: [OrderMenuItem!]!, $payment_type: String!) {
  createOrder(
 ...
 * });
 */
export function useCustomerLoginQuery(baseOptions: Apollo.QueryHookOptions<CustomerLoginQuery, CustomerLoginQueryVariables> & ({ variables: CustomerLoginQueryVariables; skip?: boolean; } | { skip: boolean; }) ) {
        const options = {...defaultOptions, ...baseOptions}
 ...
 * });
 */
export function useCustomerVerifyCodeQuery(baseOptions: Apollo.QueryHookOptions<CustomerVerifyCodeQuery, CustomerVerifyCodeQueryVariables> & ({ variables: CustomerVerifyCodeQueryVariables; skip?: boolean; } | { skip: boolean; }) ) {
        const options = {...defaultOptions, ...baseOptions}
 ...
 * });
 */
export function useGetMenuItemsForCartQuery(baseOptions: Apollo.QueryHookOptions<GetMenuItemsForCartQuery, GetMenuItemsForCartQueryVariables> & ({ variables: GetMenuItemsForCartQueryVariables; skip?: boolean; } | { skip: boolean; }) ) {
        const options = {...defaultOptions, ...baseOptions}
...
export function useGetMenuItemsForCartSuspenseQuery(baseOptions?: Apollo.SuspenseQueryHookOptions<GetMenuItemsForCartQuery, GetMenuItemsForCartQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<GetMenuItemsForCartQuery, GetMenuItemsForCartQueryVariables>(GetMenuItemsForCartDocument, options);
        }
...
export type GetMenuItemsForCartSuspenseQueryHookResult = ReturnType<typeof useGetMenuItemsForCartSuspenseQuery>;
...
export const UpdateCustomerDataDocument = gql`
  ...
  update_customers_by_pk(
    pk_columns: {id: $id}
    _set: {address: $address, name: $name, phone: $phone}
  ) {
    id
    address
    name
